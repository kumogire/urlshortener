...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    var uri = 'http://localhost/api/shortenedurls';
  ...
  methods: {
    deletePost: function deletePost(id) {
      ...
      var uri = "http://localhost/api/shortenedurl/delete/".concat(id);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    addURL: function addURL() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('http://localhost/api/shortenedurl/create?token=' + process.env.API_TOKEN, this.post).then(function (response) {
        ...
        _c("div", { staticClass: "card" }, [
          ...
          _c(
            ...
            [
              _c("p", [
                _vm._v(
                  "Great things come in small packages. This especially applies to URLs."
                ),
              ]),
              _vm._v(" "),
              _c("p", [
                _vm._v("Let's turn those ginormous URLs into cute short URLs:"),
              ]),
              _vm._v(" "),
